...
//             variants={variants}
//             className={`px-10 py-12 flex flex-col border border-r-2 w-1/5 h-screen relative ${isExpanded ? "px-10" : "px-4"
//                 }`}>
...
//                 className='w-5 h-5 bg-[#5DBC5D] rounded-full absolute -right-[10.5px] top-14 flex items-center justify-center'>
//                 <img src={RightArrow} className='w-[5px]' />
//             </div>

//             <div className='mt-10 flex flex-col space-y-8'>
//                 {navLinks.map((item, index) => <div key={index}>
//                     <div key={index} className={"flex space-x-3 p-2 rounded" + (isExpanded ? "" : "mx-auto") + (activeNavIndex === index ? " bg-[#5DBC5D] text-white font-semibold" : " ")}
