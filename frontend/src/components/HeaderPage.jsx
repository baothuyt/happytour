  ...
  return (
    <header className={styles.navbar}>
        ...
        <nav className={styles.navbar_center}>
            ...
            <Link to="/" ><a href="#" className={styles.nav_item}><i className="fas fa-home"></i> Trang chủ</a></Link> 
            <Link to="/" ><a href="#" className={styles.nav_item}><i className="fas fa-map-marker-alt"></i> Địa điểm</a></Link>
            <a href="#" className={styles.nav_item}><i className="fas fa-users"></i> Về chúng tôi</a>
            <Link to="/blog" ><a href="#" className={styles.nav_item}><i className="fas fa-camera"></i> Blog</a></Link> 
